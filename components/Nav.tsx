      ...
      <header className="sticky top-0 z-50 border-b border-line bg-ink/90 backdrop-blur">
        <div className="flex items-stretch justify-between">
          ...
          <Link
            ...
            className="flex h-14 items-center gap-2 border-r border-line px-4 transition-colors hover:bg-surface sm:px-6"
          >
            ...
            {links.map((link) => {
              ...
              return (
                <Link
                  key={link.href}
                  href={link.href}
                  className={`flex h-14 items-center px-6 border-r border-line text-[10px] uppercase tracking-[0.2em] transition-colors lg:px-8 ${
                    active
          ...
          <div className="flex items-stretch">
            <a
              ...
              className="hidden h-14 items-center border-l border-line px-6 text-[10px] uppercase tracking-[0.2em] text-muted transition-colors hover:bg-surface hover:text-paper lg:flex"
            >
              Resume
            </a>
            ...
            <button
              ...
              className="flex h-14 items-center border-l border-line px-4 transition-colors hover:bg-surface sm:px-5"
